...
<footer class="landing-footer bg-body footer-text mt-6">
  <div class="footer-top position-relative overflow-hidden z-1">
    <img src="<?php echo e(asset('assets/img/front-pages/backgrounds/footer-bg-'.$configData['style'].'.png')); ?>" alt="footer bg" class="footer-bg banner-bg-img z-n1" data-app-light-img="front-pages/backgrounds/footer-bg-light.png" data-app-dark-img="front-pages/backgrounds/footer-bg-dark.png" />
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5">
          <a href="<?php echo e(route('home')); ?>" class="app-brand-link mb-4">
            <span class="app-brand-logo demo">
                <img src="<?php echo e(asset('assets/img/branding/inlando-logo.svg')); ?>" alt="Inlando Logo" class="footer-brand-logo" style="height: 50px; width: auto;">
            </span>
          </a>
  ...
  <div class="footer-bottom py-3 py-md-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      <div class="mb-2 mb-md-0">
        <span class="footer-bottom-text">© <?php echo e(date('Y')); ?> Inlando. Alle Rechte vorbehalten.</span>
      </div>
      <div>
...
<!-- Footer: End -->
<?php /**PATH /Users/g470/Sites/platform_architecture_big/development/admin-laravel/resources/views/layouts/frontend/sections/footer/footer.blade.php ENDPATH**/ ?>