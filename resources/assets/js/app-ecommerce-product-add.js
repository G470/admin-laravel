...
$(function () {
  // Mary UI Choices (migrated from Select2)
  var select2 = $('.select2');
  if (select2.length) {
    if (typeof Choices !== 'undefined') {
      select2.each(function () {
        const element = this;
        const placeholder = $(element).data('placeholder') || 'Select option';
        new Choices(element, {
          searchEnabled: true,
          itemSelectText: '',
  ...
  if (formRepeater.length) {
    ...
    formRepeater.repeater({
      show: function () {
        ...
        if (typeof Choices !== 'undefined') {
          $('.select2.form-select').each(function () {
            new Choices(this, {
              searchEnabled: true,
              itemSelectText: '',
              removeItemButton: true,
          ...
          $('.form-repeater:first .form-select').each(function () {
            new Choices(this, {
              searchEnabled: true,
              itemSelectText: '',
              removeItemButton: true,
