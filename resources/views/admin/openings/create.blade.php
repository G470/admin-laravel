...
@section('title', 'Öffnungszeiten erstellen')
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Neue Öffnungszeiten erstellen</h5>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form method="POST" action="{{ route('admin.openings.store') }}">
                        @csrf
                            ...
                            <select class="form-select @error('location_id') is-invalid @enderror" 
                                ...
                                @foreach($locations as $location)
                                    <option value="{{ $location->id }}" 
                                            {{ (old('location_id', $selectedLocationId) == $location->id) ? 'selected' : '' }}>
                        ...
                        <div id="time-fields" style="{{ old('is_closed') ? 'display: none;' : '' }}">
                            <div class="row mb-3">
                                <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Besondere Hinweise für diesen Tag...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
