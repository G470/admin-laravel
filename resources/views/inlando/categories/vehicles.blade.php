...
@section('title', 'Fahrzeuge mieten')

@section('content')
<div class="container py-5">
    <div class="row">
        <div class="col-12">
            <h1 class="mb-4">Fahrzeuge mieten</h1>
            <p class="lead mb-5">Nutzfahrzeuge & Freizeitfahrzeuge für Transport, Urlaub und Ausflüge</p>
        </div>
    </div>
                    ...
                    <div class="card card-hover h-100 shadow-sm border-0">
                        ...
                        @else
                            <div class="card-img-top bg-light d-flex align-items-center justify-content-center" style="height: 200px;">
                                <i class="ti ti-car ti-xl text-muted"></i>
                            </div>
                        @endif
