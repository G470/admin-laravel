...
@section('title', 'Eventartikel mieten')

@section('content')
<div class="container py-5">
    <div class="row">
        <div class="col-12">
            <h1 class="mb-4">Eventartikel mieten</h1>
            <p class="lead mb-5">Alles was du für dein nächstes Event benötigst</p>
        </div>
    </div>
                    ...
                    <div class="card card-hover h-100 shadow-sm border-0">
                        ...
                        @else
                            <div class="card-img-top bg-light d-flex align-items-center justify-content-center" style="height: 200px;">
                                <i class="ti ti-calendar-event ti-xl text-muted"></i>
                            </div>
                        @endif
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-info text-center">
                    ...
                    Derzeit sind keine Eventartikel verfügbar.
                </div>
            </div>
        @endforelse
    </div>
