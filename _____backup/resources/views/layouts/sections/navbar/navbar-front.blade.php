    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium" href="#">Kategorien</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="#">Wie es funktioniert</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="#">Über uns</a>
          </li>
          </li>
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item me-2 me-xl-0">
          <a class="nav-link fw-medium" href="#">Jetzt vermieten</a>
        </li>
        <li class="nav-item me-2 me-xl-0">
          <a class="btn btn-outline-primary waves-effect" href="#">Anmelden</a>
        </li>
        <li class="nav-item">
          <a class="btn btn-primary waves-effect waves-light" href="#">Registrieren</a>
        </li>
      </ul>
      <!-- Toolbar: End -->
    </div>
